...
charts = [
    ...
    ("Chart 2: Sales Trend", chart_gen.chart_2_sales_trend_line),
    ("Chart 3: Market Share", chart_gen.chart_3_market_share_pie),
    ("Chart 4: Price vs Rating", chart_gen.chart_4_price_vs_rating_scatter),
    ...
    ("Chart 7: ROI by Publisher", chart_gen.chart_7_roi_by_publisher_box),
    ...
    ("Chart 10: Player Count", chart_gen.chart_10_player_count_power_bubble),
]
